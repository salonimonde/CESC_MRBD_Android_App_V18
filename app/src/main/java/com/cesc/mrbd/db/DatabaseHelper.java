...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        // TODO: 22-04-2019 Update query removed for one kota user. Uncomment below lines for normal V17 app
...
*/
    ...
    private void createUploadDisconnectionTable(SQLiteDatabase db) {
        String UploadDisconnectionTableFields = UploadDisconnectionTable.Cols.ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                ...
                UploadDisconnectionTable.Cols.METER_NO + " VARCHAR, " +
                UploadDisconnectionTable.Cols.METER_IMAGE + " BLOB, " +
